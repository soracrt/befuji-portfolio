          ...
          <div>
            ...
            {project.editedBy && (
              <p className="font-sans text-xs mt-0.5" style={{ color: 'rgba(238,229,233,0.35)' }}>
                Edited by{' '}
                {project.editorLink ? (
                  <a href={project.editorLink} target="_blank" rel="noopener noreferrer" className="font-bold transition-colors duration-150 hover:text-[#EEE5E9]" style={{ color: '#EEE5E9' }}>{project.editedBy}</a>
                ) : (
                  <span className="font-bold" style={{ color: '#EEE5E9' }}>{project.editedBy}</span>
                )}
              </p>
            )}
          </div>
            ...
            >
              {project.image ? (
                <img
                  src={project.image}
                  alt={project.title}
                  className="w-full h-full object-cover [transition:filter_0.45s_cubic-bezier(0.25,0.1,0.25,1)] group-hover/img:[filter:blur(0.5px)]"
                  draggable={false}
                />
              ) : (
                <div
              ...
              {absUrl && (
                ...
                >
                  <span
                    ...
                    style={{ background: 'rgba(207,92,54,0.25)', color: '#fff', border: '1px solid rgba(207,92,54,0.7)', boxShadow: '0 0 24px rgba(207,92,54,0.8), 0 0 60px rgba(207,92,54,0.45), 0 0 100px rgba(207,92,54,0.2)', fontWeight: 700 }}
                  >
