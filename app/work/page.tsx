          ...
          <div>
            ...
            {project.editedBy && (
              <p className="font-sans text-xs mt-0.5" style={{ color: 'rgba(238,229,233,0.35)' }}>
                Edited by{' '}
                {project.editorLink ? (
                  <a href={project.editorLink} target="_blank" rel="noopener noreferrer" className="font-bold transition-colors duration-150 hover:text-[#EEE5E9]" style={{ color: 'rgba(238,229,233,0.35)' }}>{project.editedBy}</a>
                ) : (
                  <span className="font-bold">{project.editedBy}</span>
                )}
              </p>
            )}
          </div>
